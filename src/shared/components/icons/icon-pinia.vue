<template>
	<svg class="pinia-container" width="150" height="150" viewBox="0 0 408 520" fill="none"
		...
		<g class="body">
			...
			<g class="eye-left">
				...
				<path fill-rule="evenodd" v-else clip-rule="evenodd"
			...
			<path fill-rule="evenodd" clip-rule="evenodd"
				...
				fill="#ECB732" />
			<path fill-rule="evenodd" clip-rule="evenodd" v-if=" !talking || talking == 'closed' "
